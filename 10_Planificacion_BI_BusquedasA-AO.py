...
def ao_estrella(grafo, inicio, objetivo):
    ...
    while por_visitar:
        ...
        for vecino, costo in grafo[nodo_actual].items():
            ...
            padres[vecino] = nodo_actual
            costos[vecino] = nuevo_costo
            estimacion = distancia_euclidiana(vecino, objetivo) + nuevo_costo
            por_visitar.append((vecino, nuevo_costo, estimacion))
...
print(f"Buscando el camino más corto desde '{inicio}' hasta '{objetivo}' utilizando AO*:")
camino = ao_estrella(grafo, inicio, objetivo)
if camino:
    print("El camino encontrado es:", camino)
else:
    print("No se encontró ningún camino.")
