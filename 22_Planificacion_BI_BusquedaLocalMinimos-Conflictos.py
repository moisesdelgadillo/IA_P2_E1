...
def minimos_conflictos(asignacion_actual, variables, dominios, restricciones, max_iter):
...
solucion = minimos_conflictos(asignacion_inicial, variables, dominios, restricciones, max_iter)
